...
int calculateTagSize(int cacheBits, int indexSize, int offsetSize) { return cacheBits - indexSize - offsetSize; }
...
int main(int argc, char* argv[]) {
    ...
    int implementMemSize = calculateImplementationMemorySize(cacheSize, overheadSize);
